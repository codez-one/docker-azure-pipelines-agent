...
VSO_AGENT_IGNORE=_,MAIL,OLDPWD,PATH,PWD,VSO_AGENT_IGNORE,AZDO_AGENT,AZDO_URL,AZDO_USER,AZDO_PASSWORD,AZDO_POOL,AZDO_WORK,AZDO_AGENT_DISPOSE,DOTNET_CLI_TELEMETRY_OPTOUT,AGENT_ALLOW_RUNASROOT,DEBIAN_FRONTEND
